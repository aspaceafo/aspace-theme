...
function list_all_posttypes() {
   global $post;
       ...
       wp_register_script('jquery', ("http://ajax.googleapis.com/ajax/libs/jquery/1.4.1/jquery.min.js"), false, '1.3.2'); 
	...
	//removed "Protected:" from titles of pwrd protected pages
